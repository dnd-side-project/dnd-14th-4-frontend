...
export { default as IcSvgArrowLeftBig } from './ic_arrowleftbig';
export { default as IcSvgArrowLeftSmall } from './ic_arrowleftsmall';
export { default as IcSvgArrowRightBig } from './ic_arrowrightbig';
...
export { default as IcSvgHoriz } from './ic_horiz';
