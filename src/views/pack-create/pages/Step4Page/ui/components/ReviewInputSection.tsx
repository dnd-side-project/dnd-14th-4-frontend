    ...
    <>
      ...
      <div>
        <textarea
          ...
          className="h-28 w-full resize-none rounded-xl border border-neutral-200 px-4 py-3 text-neutral-900 dark:text-neutral-900 placeholder:text-neutral-500 dark:placeholder:text-neutral-500 focus:outline-none"
        />
