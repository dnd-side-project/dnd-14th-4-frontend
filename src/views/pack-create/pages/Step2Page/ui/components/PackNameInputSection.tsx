  ...
  return (
    <div>
      <input
        ...
        className="w-full border-b border-neutral-200 bg-transparent pb-3 text-neutral-900 dark:text-neutral-900 placeholder:text-neutral-500 dark:placeholder:text-neutral-500 focus:outline-none"
      />
