...
const placeholderClass = "text-sm text-neutral-500 dark:text-neutral-500";
  ...
  return (
    <div className={barClass}>
      ...
      <input
        ...
        className="h-full w-full bg-transparent text-sm text-neutral-800 dark:text-neutral-800 outline-none placeholder:text-neutral-500 dark:placeholder:text-neutral-500"
      />
    </div>
  );
}