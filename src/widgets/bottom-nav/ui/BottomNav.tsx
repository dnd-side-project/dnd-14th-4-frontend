...
export const BottomNav = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-mobile bg-white border-t border-gray-100 h-[72px] flex justify-between px-5 z-30 pt-2 pb-[46px]">
